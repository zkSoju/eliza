...
export class BridgeAction {
  ...
  async bridge(params: BridgeParams): Promise<Transaction> {
    ...
    const routes = await getRoutes({
      fromChainId: getChainConfigs(this.walletProvider.runtime)[params.fromChain].chainId as ChainId,
      toChainId: getChainConfigs(this.walletProvider.runtime)[params.toChain].chainId as ChainId,
